...
namespace GeonBit.UI {
    ...
    public class UserInterface : IDisposable {
        ...
        public bool UseRenderTarget {
            get {
                return _useRenderTarget;
            }
            set {
                _useRenderTarget = value;
                DisposeRenderTarget();
            }
        }
        ...
        private static Entity DefaultGenerateTooltipFunc(Entity source) {
            ...
            tooltip.BeforeDraw += (Entity ent) => {
                ...
                if (position.X > screenBounds.Right - destRect.Width)
        ...
        public void Update(GameTime gameTime) {
            ...
            if (MouseInputProvider != KeyboardInputProvider) {
                KeyboardInputProvider.Update(gameTime);
            }
            ...
            if (_tooltipEntity == null) {
                ...
                if (_timeUntilTooltip > TimeToShowTooltipText) {
                    ...
                    if (_tooltipEntity != null) {
                        ...
                        this.Root.AddChild(_tooltipEntity);
                    }
                }
            }
        }
        ...
        public void SetCurrentScreen(Type screenType) {
            Screen screen = this.screens.FirstOrDefault(s => s.GetType().Equals(screenType));
            if (screen != null) {
                this.Root.SetCurrentScreen(screen);
            }
        }
